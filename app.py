...
with colForm:
    ...
    st.markdown("<div class='addr-helper'>Les suggestions apparaissent automatiquement dès 2 caractères.</div>",
                unsafe_allow_html=True)
    ...
    with c2:
        ...
        st.markdown(
            "<div style='margin-top:0.5rem; font-size:0.82rem; color:#475569; font-style:italic; line-height:1.5'>"
